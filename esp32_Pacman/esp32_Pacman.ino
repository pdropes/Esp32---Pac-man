...
//--------------------------------------------------------------------------------------------
    void Score(int16_t delta)
    {
      ...
      if (DEMO == 0 ) _hiscore_new = _score; // not anymore :)

      if (_score > _lifescore && _score % 10000 > 0) {
        _lifescore = (_score / 10000 + 1) * 10000;

        LIFES++; // EVERY 10000 points = 1UP (Just on 1st 10000 ?!)
      ...
      // Check battery
      Bat = (analogReadMilliVolts(Pin_bat) - 1422) * 0.176;
      if (Bat > 100) Bat = 100;
      if (Bat < 0) Bat = 0;
      ...
      if (Bat != Bat_old) {
        ...
        tft.print(Bat_old + (String)" %");
        Bat_old = Bat;

        tft.setCursor(200, 10);
        tft.setTextColor(ST77XX_RED);
        tft.print(Bat + (String)" %");
      }
      // analog / 474 = voltage
      // 4.2V = analog 1990
      // 3.0V = analog 1422
